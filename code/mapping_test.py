...
if __name__ == '__main__':
    ...
    residence_names = pd.read_csv('municipality_mapping/data/data-1730366425179.csv', encoding='utf-8')
    ...
    hometown_names = pd.read_csv('municipality_mapping/data/data-1730366364994.csv', encoding='utf-8')
    ...
    updated_df = asyncio.run(
        code_mapper.map_multiple_gemeindestaende_to_newest(results_df, 'matched_id', 'gmde_stand_original')
    )
